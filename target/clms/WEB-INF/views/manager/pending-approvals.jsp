                                                ...
                                                <div class="modal fade" id="actionModal${req.requestId}" tabindex="-1">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="${pageContext.request.contextPath}/manager/approve-reject" method="post">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Manager Remarks (Required for Reject)</label>
